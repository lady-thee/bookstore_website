...
class LoginAPISTestcase(APITestCase):
    ...
    def test_login_user(self):
        ...
        login_data = {"username_or_email": "janedoe@gmail.com", "password": "2030"}
...
class AuthenticateRequiredAPIViewsTestcase(APITestCase):
    def setUp(self):
        ...
        """
         login requirement
        """
        self.login_data = {"username_or_email": "janedoe@gmail.com", "password": "2030"}

        self.access_token = self.client.post(
            reverse("login"), self.login_data, format="json"
        )
